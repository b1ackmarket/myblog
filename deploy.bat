...
if %errorlevel% neq 0 (
    ...
    :: === 关键修复：给它 2 秒钟握手时间 ===
    echo [INFO] Waiting 2 seconds for handshake...
...
echo ==========================================
echo [2/3] Step 2: Clean Remote Files
echo ==========================================
...
echo ==========================================
echo [3/3] Step 3: Push New Files
echo ==========================================
...
if %errorlevel% == 0 (
    ...
    echo.
    echo Please refresh your blog on phone.
    echo ==========================================
) else (
    echo.
    echo ==========================================
